...
public class NotificationTests extends BaseTest {
    ...
    @Test(priority = 3, retryAnalyzer = RetryAnalyzer.class) public void TC_NOTF_006_dashboardStatCards() { navigateToSection("dashboard"); int count = (int)(long)(Long)executeScript("return document.querySelectorAll('.stat-card').length;"); Assert.assertTrue(count>=0); }
