...
public class NavigationTests extends BaseTest {
    ...
    @Test(priority = 2, retryAnalyzer = RetryAnalyzer.class) public void TC_NAV_018_onlyOneSectionActive() { navPage.goToMarket(); int activeSections = (int)(long)(Long)executeScript("return document.querySelectorAll('.section.active').length;"); Assert.assertEquals(activeSections, 1); }
